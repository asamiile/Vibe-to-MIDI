...
- [x] Pro-gated MIDI export
  - Bytes generation is implemented.
  - Android file save/share transport is implemented.
...
### ~~1. MIDI File Save / Share~~ ✓ Complete — see `.agents/qa-midi-share.md`

- [x] Confirm Expo SDK 54 compatibility for file/share dependencies.
- [x] Confirm dependency licenses.
- [x] Add file/share dependency only after compatibility is confirmed.
- [x] Add `app/frontend/src/features/midi-export/share-midi.ts`.
- [x] Keep `export-midi.ts` focused on bytes generation.
- [x] Write generated bytes to a `.mid` file.
- [x] Open Android share sheet for the generated `.mid`.
- [x] Show success state after share/save.
- [x] Show failure state if file/share fails.
- [x] Add tests with native APIs mocked.
- [x] Update this roadmap when file transport is complete.
